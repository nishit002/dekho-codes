...
# Function to display estimated time for completion
def estimate_completion_time(num_keywords):
    if start_time:
        elapsed = datetime.now() - start_time
        estimated_time = elapsed / max(1, (keywords_processed / num_keywords))
        return start_time + estimated_time
    return "Calculating..."
